...
/// Camera for the curved-spacetime renderer.
///
/// Position lives in the metric's coordinate chart (t, r, θ, φ). The look_at
/// and up vectors are interpreted in the camera's local Cartesian frame and
/// projected onto the local orthonormal spherical basis when emitting rays.
pub struct Camera {
